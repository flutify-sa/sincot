              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    await _showAcceptContractDialog(context);
...
''';
                    ...
                    // Print the contract text to verify
                    print(fullContractText);
  ...
  Future<void> _showAcceptContractDialog(BuildContext context) async {
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(labelText: 'SA ID'),
                ),
                TextField(
                  controller: workerpinController,
                  decoration: const InputDecoration(labelText: 'Worker Pin'),
                ),
                TextField(
                  controller: childrenNamesController,
                  decoration:
                      const InputDecoration(labelText: 'Children Names'),
                ),
                TextField(
                  controller: parentDetailsController,
                  decoration:
                      const InputDecoration(labelText: 'Parent Details'),
                ),
              ],
            ),
          ),
