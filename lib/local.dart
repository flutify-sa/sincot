              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    // Enable the Profile button after some action (e.g., accepting)
                    setState(() {
                      isProfileButtonActive = true; // Enable the button
                    });
                  },
                  style: ElevatedButton.styleFrom(
            ...
            TextButton(
              onPressed: () async {
                ...
                if (name.isNotEmpty && surname.isNotEmpty) {
                  ...
                  bool isUploadSuccessful = await _generateAndUploadPdf(
                      name, surname); // Save and upload PDF
  ...
  Future<bool> _generateAndUploadPdf(String name, String surname) async {
    try {
      ...
      final supabase = SupabaseClient(
        ...
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVlcGRkdWdkZmdiZ3Jrb3R3aHJnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzY4NDA8NDIsImV4cCI6MjA1MjQxNjg0Mn0.9EphzmdSCuj0mmceBP9EWcZ4rP4XYFkzeygsq2-KjYA',
      );
