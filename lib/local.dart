...
class _LocalContractPageState extends State<LocalContractPage> {
  ...
  String createTextWidgetContent(String name, String surname) {
    ...
    // Construct the text
    return "I $name $surname accept the contract.\n$formattedDate";
  }
            ...
            TextButton(
              onPressed: () async {
                ...
                if (name.isNotEmpty && surname.isNotEmpty) {
                  ...
                  String textContent = createTextWidgetContent(name, surname);
                  ...
                  bool isUploadSuccessful = await saveTextToSupabaseStorage(
                    textContent,
                  ...
                  if (isUploadSuccessful) {
                    ...
                    print('Text saved to Supabase Storage successfully!');
                    ...
                    print(
                        'Failed to save text to Supabase Storage. Please try again.');
                  }
                }
              },
              child: Text('Save'),
